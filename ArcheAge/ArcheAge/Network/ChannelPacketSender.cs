...
using System.Linq;
using System.Net;
using ArcheAgeGame.ArcheAge.Network.Helpers;
...
namespace ArcheAgeGame.ArcheAge.Network
{
	public static class Send
	{
		...
		public static void ZC_ABILITY_LIST(Character character)
		{
			...
			//var abilityNames = ArcheAgeGame.Instance.Data.JobDb.Find(character.Job).DefaultAbilities;
			//var abilities = ArcheAgeGame.Instance.Data.AbilityDb.Where(a => abilityNames.Contains(a.ClassName)).Select(a => a.Id);
		...
		/// <param name="y"></param>
		/// <param name="z"></param>
		public static void ZC_PC_MOVE_STOP(Character character, Position position, Direction2 direction)
		{
		...
		public static void ZC_NORMAL_Skill(Character character, int id, Position position, Direction2 direction, bool create)
		{
		...
		/// <param name="position"></param>
		/// <param name="direction"></param>
		public static void ZC_NORMAL_Unkown_1c(Character character, int handle, Position position, Direction2 direction)
		{
			var packet = new Packet(Op.ZC_NORMAL);
		...
		/// <param name="position"></param>
		/// <param name="direction"></param>
		public static void ZC_SKILL_RANGE_FAN(Character character, int id, Position position, Direction2 direction)
		{
		...
		/// </summary>
		/// <param name="character"></param>
		public static void ZC_SKILL_MELEE_GROUND(Character character, int id, Position position, Direction2 direction)
		{
		...
		public static void ZC_HELP_LIST(Character character)
		{
			...
			var defaultList = ArcheAgeGame.Instance.Data.HelpDb.Entries.Values.Where(a => a.BasicHelp);
