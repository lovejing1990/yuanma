    ...
    public sealed class NP_SCCharacterStatePacket_0x003B : NetPacket
    {
        public NP_SCCharacterStatePacket_0x003B(ClientConnection net, uint characterId) : base(01, 0x003B)
        {
            ...
            */
            ...
            //}
            //position
            ns.Write((long)LocalCommons.Utilities.Helpers.ConvertLongX(net.CurrentAccount.Character.Position.X)); //x Q
            ns.Write((long)LocalCommons.Utilities.Helpers.ConvertLongY(net.CurrentAccount.Character.Position.Y)); //y Q
