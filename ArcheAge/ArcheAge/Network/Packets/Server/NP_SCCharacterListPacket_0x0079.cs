    ...
    public sealed class NP_0x05_CharacterListPacket_0x0079 : NetPacket
    {
        ...
        public NP_0x05_CharacterListPacket_0x0079(ClientConnection net, int num, int last) : base(05, 0x0079)
        {
			...
			Character chr2 = chr;
                    ...
                    // {1}
	                this.WriteItem(chr.Head); //ItemId d Head
                    // {2}
	                this.WriteItem(chr.Chest); //ItemId d Chest
                    // {3}
	                this.WriteItem(chr.Legs); //ItemID d Legs
                    // {4}
	                this.WriteItem(chr.Gloves); //ItemID d Gloves
                    // {5}
	                this.WriteItem(chr.Feet); //ItemID d Feet
                    // {6}
	                this.WriteItem(0x17EF); //ItemID d
                    // {7}
	                this.WriteItem(0x1821); //ItemId d
