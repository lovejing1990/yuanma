...
namespace ArcheAgeGame.ArcheAge.Network
{
    ...
    {
        public NP_SCUnitMovementsPacket_0x0066(ClientConnection net,string move) : base(01, 0x0066)
        {
			//1.0.1406
			...
			//2500 DD01 6600   0A00  019BCB 01 FACC79EB 68	 780A80030000000000000000D0000000010004
			...
			ns.Write((short)0x01);
			ns.Write((Uint24)net.CurrentAccount.Character.LiveObjectId);
			ns.WriteHex(move);
			return;
			byte type = new byte();
			int time = new int();
