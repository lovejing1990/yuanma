...
namespace ArcheAgeGame.ArcheAge.World
{
	...
	public class Job
	{
		...
		public int SkillPoints
		{
			...
			set { this._skillPoints = Math2.Clamp(0, short.MaxValue, value); }
		}
		...
		public Job(Character character, JobId jobId, int totalExp, Circle circle = Circle.First, int skillPoints = 0)
		{
			...
			this.Data = ArcheAgeGame.Instance.Data.JobDb.Find(jobId) ?? throw new ArgumentException($"Unknown job '{jobId}'.");
		}
